...
#define Z2_MIN_ENDSTOP_INVERTING false // set to true to invert the logic of the probe.
/**
 * Stepper Drivers
 *
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 510.90 }
...
#define INVERT_E2_DIR false	//not in use
#define INVERT_E3_DIR false //not in use
#define INVERT_E4_DIR false //not in use
